  ...
  return (
    <div className='App'>
      <header className='App-header'>
        ...
        <p>
          Sample React app using docker, k8s, terraform and only God knows what
          else
        </p>
        <p>
          Version: 1.0.<span style={{ color: 'green' }}>{v}</span> - try
          refreshing, there should be 4 pods ❤️
        </p>
        ...
        <code style={{ fontSize: 14 }}>
          Green text color is from api, if there is none, sorry. 😭
        </code>
      </header>
    </div>
  )
